...
def get_otpl_leave_approval_list(start=0, page_length=10):
    ...
    try:
        ...
        return gen_response(200, "Leave approval list retrieved successfully", leave_list)
...
def approve_otpl_leave():
    ...
    try:
        ...
        if not approved_from_date or not approved_to_date:
            return gen_response(500, "Approved from date and approved to date are required")
        ...
        if leave_doc.approver != frappe.session.user:
            return gen_response(500, "You are not authorized to approve this leave application")
...
def reject_otpl_leave():
    ...
    try:
        ...
        # Verify that the current user is the approver
        if leave_doc.approver != frappe.session.user:
            return gen_response(500, "You are not authorized to reject this leave application")
    ...
    try:
        expense_list = frappe.get_all(
            ...
            filters={
                ...
                "approval_manager": frappe.session.user
            },
        )
        return gen_response(200, "Expense approval list retrieved successfully", expense_list)
    except frappe.PermissionError:
...
def get_employee_checkin_approval_list(start=0, page_length=10, log_type=None):
    ...
    try:
        ...
        return gen_response(200, "Checkin approval list retrieved successfully", checkin_list)
    except frappe.PermissionError:
        ...
        try:
            ...
            if existing_attendance:
                if existing_attendance.leave_application:
                    ...
                    return gen_response(200, "Check-in approved successfully. Attendance not processed due to existing leave application.")
                else:
            ...
            return gen_response(200, "Check-in approved and attendance processed successfully")
            ...
            return gen_response(200, "Check-in approved successfully but attendance processing failed. Please check error logs.")
